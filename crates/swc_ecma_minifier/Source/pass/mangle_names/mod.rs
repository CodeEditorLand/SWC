...
pub(crate) fn mangle_names(
	...
	program.visit_mut_with(&mut LabelMangler { chars, cache: Default::default(), n: Default::default() });

	program.visit_mut_with(&mut self::private_name::private_name_mangler(options.keep_private_props, chars));
