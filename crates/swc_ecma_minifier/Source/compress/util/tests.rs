...
#[test]
fn negate_cost_1() {
	assert_negate_cost("this[key] && !this.hasOwnProperty(key) || (this[key] = value)", false, true, 0);
}
...
fn negate_cost_4() {
	...
	assert_negate_cost("!(force || this._isRebuildRequired()) || self._buildList()", true, true, 2);
}
