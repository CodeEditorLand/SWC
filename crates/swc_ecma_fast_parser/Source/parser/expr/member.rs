...
impl<'a> Parser<'a> {
	...
	pub(crate) fn parse_property_access(&mut self, object: ast::Expr, optional: bool) -> Result<ast::Expr> {
	...
	pub(crate) fn parse_computed_member(&mut self, object: ast::Expr, optional: bool) -> Result<ast::Expr> {
