...
use swc_ecma_visit::{Visit, VisitMut, VisitWith, noop_visit_mut_type, noop_visit_type, visit_mut_pass};
...
impl Visit for ImportAnalyzer {
	...
	fn visit_module_items(&mut self, n: &[ModuleItem]) {
		...
		if self.import_interop.is_swc() && flag_record.values().any(|flag| flag.interop() && !flag.has_named()) {
