...
impl rkyv::with::ArchiveWith<Box<BigIntValue>> for EncodeBigInt {
	...
	fn resolve_with(field: &Box<BigIntValue>, resolver: Self::Resolver, out: rkyv::Place<Self::Archived>) {
		use rkyv::Archive;
...
{
	fn serialize_with(field: &Box<BigIntValue>, serializer: &mut S) -> Result<Self::Resolver, S::Error> {
...
{
	fn deserialize_with(field: &rkyv::Archived<String>, deserializer: &mut D) -> Result<Box<BigIntValue>, D::Error> {
...
impl From<BigIntValue> for BigInt {
	...
	fn from(value: BigIntValue) -> Self {
		BigInt { span: DUMMY_SP, value: Box::new(value), raw: None }
	}
}
...
impl Take for Str {
	fn dummy() -> Self {
		Str { span: DUMMY_SP, value: atom!(""), raw: None }
	}
}
...
impl From<Atom> for Str {
	...
	fn from(value: Atom) -> Self {
		Str { span: DUMMY_SP, value, raw: None }
	}
}
...
impl Take for Bool {
	fn dummy() -> Self {
		Bool { span: DUMMY_SP, value: false }
	}
}
...
impl Take for Regex {
	fn dummy() -> Self {
		Self { span: DUMMY_SP, exp: Default::default(), flags: Default::default() }
	}
}
...
impl From<f64> for Number {
	...
	fn from(value: f64) -> Self {
		Number { span: DUMMY_SP, value, raw: None }
	}
}
...
impl From<usize> for Number {
	...
	fn from(value: usize) -> Self {
		Number { span: DUMMY_SP, value: value as _, raw: None }
	}
}
